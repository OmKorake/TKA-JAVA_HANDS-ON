...
public class Cars {
	...
	public Cars(int id, String cno, String company, String model, String color, int price, int lonch_year,
			int seat_capy) {
		super();
		this.id = id;
		this.cno = cno;
	...
	public String toString() {
		return "Cars [id=" + id + ", cno=" + cno + ", company=" + company + ", model=" + model + ", color=" + color
				+ ", price=" + price + ", lonch_year=" + lonch_year + ", seat_capy=" + seat_capy + "]";
	}
